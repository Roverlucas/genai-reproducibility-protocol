...
Revision total: 1{,}200 (HumanEval) + 1{,}200 (GSM8K) + 400 (PubMed PM\textsubscript{2.5}) + 100 (multi-turn extension) = 2{,}900 logged generative-AI runs, bringing the manuscript-wide total to 7{,}004 runs across 9 deployment stacks and 6 task families. An additional 60 LLM-as-judge calls (30 Claude Opus 4.7 + 30 gpt-4o, total cost USD~1.30, see Section~\ref{sec:s12}) support the applied-impact triangulation but are reported separately as they belong to the validation layer rather than the primary experimental matrix.
