...
%DIF ADD article/ncomms_main.tex                          Mon May 11 17:50:04 2026
...
\begin{figure*}[t]
  ...
  \textbf{Right:} Key statistics: 4\DIFaddbeginFL {\DIFaddendFL ,\DIFaddbeginFL }\DIFaddendFL 104 experiments, 9 deployment stacks, 7 execution environments,
...
Its key property is \emph{differential diagnosis}: when all hashes match except the output hash, the divergence is automatically attributed to the generation process, a result confirmed across all 4\DIFdelbegin \DIFdel{,}\DIFdelend \DIFaddbegin {\DIFadd{,}}\DIFaddend 104 runs (Supplementary Section~S4).
