...
\begin{enumerate}[leftmargin=*,resume]
  ...
  \item \textbf{Mechanism-by-stack mapping (R3.5).} A new Extended Data Table maps each of the six known mechanisms of distributed-inference non-determinism to each deployment stack, with explicit labels (active / likely / possible / not applicable) and an inferential caveat for closed-source stacks. A compact version of this mapping has been promoted into the main Methods (Table~2) for autonomous in-text readability.
