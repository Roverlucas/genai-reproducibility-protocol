...
\midrule
  ...
  \addlinespace
  Gemini 2.5 Pro & Multi-turn Refinement & \cellcolor{red!20}0.010\,[0.00,\,0.03] & 0.163 & 0.891 & --- \\
   & RAG Extraction & \cellcolor{red!20}0.070\,[0.02,\,0.13] & 0.196 & 0.850 & --- \\
\bottomrule
\end{tabular}
\par\smallskip\raggedright\footnotesize
\textit{Note:} BERTScore F1 (BS-F1) was not computed for Gemini 2.5 Pro (marked ``---'') because the embedding model was not available during the Gemini experiment phase. ROUGE-L confirms high lexical overlap despite near-zero EMR.
\end{table}
