...
We are pleased to submit the manuscript entitled \textbf{``Logging, Versioning, and Provenance in Generative AI Studies: A Protocol for Auditability and Scientific Reproducibility''} for consideration for publication in the \textit{Journal of Artificial Intelligence Research}.
...
The protocol adds negligible overhead (0.69\% of inference time, 4.17~KB per run) while providing complete audit trails, tamper detection via cryptographic hashing, and interoperable provenance graphs. We hope this work will contribute to raising the bar for reproducibility in generative AI research.
