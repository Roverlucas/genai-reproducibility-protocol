...
\textbf{English-only, academic texts.} Our input data consists of five English scientific abstracts. The reproducibility characteristics we observe may differ for other languages, domains, or document types.
