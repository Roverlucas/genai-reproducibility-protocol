...
\author{Lucas Rover}
\authornote{Corresponding Author. ORCID: \texttt{0000-0000-0000-0000}.}
...
\renewcommand{\shortauthors}{Rover}
...
\begin{itemize}
    \item \textbf{Implementation effort}: Our reference implementation adds approximately 500 lines of Python (the protocol core) to an existing workflow. Integration requires 3--5 function calls per run.
