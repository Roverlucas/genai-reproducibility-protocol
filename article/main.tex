...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item[\ding{51}] \textbf{Hyperparameters}: All inference parameters documented per model (Appendix~\ref{app:api-payloads}); temperature = 0, max\_tokens = 1024 across all models.
    ...
    \item[\ding{51}] \textbf{Randomness control}: Random seeds documented; bootstrap seed = 42; five experimental conditions (C1--C5) isolate seed and parameter effects.
