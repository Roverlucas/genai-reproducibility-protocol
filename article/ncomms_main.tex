...
\end{tabular}
\\[4pt]
{\scriptsize \textsuperscript{a}FP non-associativity, BF16/FP16 mixed-precision; \textsuperscript{b}latency, multi-tenancy, request routing; \textsuperscript{c}tensor parallelism, FlashAttention, dynamic batching, speculative decoding; \textsuperscript{*}GPT-4, Claude, Gemini, DeepSeek, Perplexity.}
\end{table}
...
\setcounter{table}{7}% Align table number with Extended Data Table 8 stub above
\begin{table*}[h]
\centering
\footnotesize
