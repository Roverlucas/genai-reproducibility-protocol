...
\toprule
\textbf{Stack class} & \textbf{FP/quant arithmetic} & \textbf{Cloud-network factors} & \textbf{Production-serving complexity} \\
 & (FP non-associativity, BF16/FP16) & (latency, multi-tenancy, routing) & (tensor par., FlashAttn., dyn.\ batching, spec.\ decoding) \\
\midrule
