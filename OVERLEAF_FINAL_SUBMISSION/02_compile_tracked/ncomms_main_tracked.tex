...
%DIF ADD ncomms_main_NEW_current.tex              Thu Jun 11 10:20:29 2026
...
To probe whether the resulting textual divergence is cosmetic or substantive, we ran a blinded \DIFaddbegin \DIFadd{two-judge }\DIFaddend LLM-as-judge protocol on \DIFdelbegin \DIFdel{10 }\DIFdelend \DIFaddbegin \DIFadd{30 }\DIFaddend newly sampled non-identical \DIFdelbegin \DIFdel{Claude }\DIFdelend output pairs from the PM\textsubscript{2.5} \DIFdelbegin \DIFdel{corpus---distinct }\DIFdelend \DIFaddbegin \DIFadd{corpus (18 Claude Sonnet 4.5 and 12 GPT-4.1 cases, stratified by disagreement kind---direction, magnitude, CI overlap, mixed---and distinct }\DIFaddend from the 23 study-level cases analysed in the companion paper\DIFaddbegin \DIFadd{)}\DIFaddend .
...
\begin{figure}[t]
  ...
  Heatmap of EMR across extraction and \DIFdelbeginFL \DIFdelFL{summarization }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{summarisation }\DIFaddendFL tasks under temperature~$=$~0
