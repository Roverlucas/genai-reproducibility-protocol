...
%DIF ADD ncomms_main_NEW_current.tex              Thu Jun 11 11:20:40 2026
...
\textbf{\DIFdelbegin \DIFdel{Revision extensions.}%DIFDELCMD < \MBLOCKRIGHTBRACE %%%
\DIFdel{Following reviewer requests during the major revision (R3.3}\DIFdelend \DIFaddbegin \DIFadd{Code}\DIFaddend , \DIFdelbegin \DIFdel{R3.4}\DIFdelend \DIFaddbegin \DIFadd{mathematics}\DIFaddend , \DIFdelbegin \DIFdel{R3.6), three additional }\DIFdelend \DIFaddbegin \DIFadd{and cross-domain tasks.}} \DIFadd{Three further }\DIFaddend batches were logged under C1, each with five repetitions per problem and the same Run Card / Prompt Card provenance discipline as \DIFdelbegin \DIFdel{the original runs}\DIFdelend \DIFaddbegin \DIFadd{Tasks~1--4}\DIFaddend .
