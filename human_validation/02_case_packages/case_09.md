...
**Identifier (for your form):** `HV-CASE-009`
...
```
effect_measure: OR
effect_estimate: 1.06
95% CI: [1.03, 1.09]
lag: average weekly
outcome: bronchiolitis
exposure_increment: per IQR
```
...
```
effect_measure: OR
effect_estimate: 0.99
95% CI: [0.94, 1.05]
lag: average weekly
outcome: bronchiolitis, females, PM10
exposure_increment: per IQR
```

---

## Your rating for case 09
